/*----- PROTECTED REGION ID(VacuumValveSrv.h) ENABLED START -----*/
//=============================================================================
//
// file :        VacuumValveSrv.h
//
// description : Include file for the VacuumValveSrv class
//
...
#ifndef VacuumValveSrv_H
#define VacuumValveSrv_H
...
/*----- PROTECTED REGION END -----*/	//	VacuumValveSrv.h
...
{
/*----- PROTECTED REGION ID(VacuumValveSrv::Additional Class Declarations) ENABLED START -----*/

//	Additional Class Declarations
class ValveCallback;

/*----- PROTECTED REGION END -----*/	//	VacuumValveSrv::Additional Class Declarations

class VacuumValveSrv : public TANGO_BASE_CLASS
{

/*----- PROTECTED REGION ID(VacuumValveSrv::Data Members) ENABLED START -----*/
...
/*----- PROTECTED REGION END -----*/	//	VacuumValveSrv::Data Members
...
public:
	...
	//	GPIO_Close:	GPIO pin to check the close status of the valve
	Tango::DevShort	gPIO_Close;
	//	GPIO_Command:	GPIO pin to control the valve opening
	Tango::DevShort	gPIO_Command;
	//	GPIO_Open:	GPIO pin to check the open status of the valve
	Tango::DevShort	gPIO_Open;
...
public:
	 ...
	 *	@param s 	Device Name
	 */
	VacuumValveSrv(Tango::DeviceClass *cl,string &s);
	/**
	 * Constructs a newly device object.
	 *
	 *	@param cl	Class.
	 *	@param s 	Device Name
	 */
	VacuumValveSrv(Tango::DeviceClass *cl,const char *s);
	/**
	 * Constructs a newly device object.
	 *
	 *	@param cl	Class.
	 ...
	 */
	VacuumValveSrv(Tango::DeviceClass *cl,const char *s,const char *d);
	/**
	 * The device object destructor.
	 */
	~VacuumValveSrv() {delete_device();};
...
/*----- PROTECTED REGION ID(VacuumValveSrv::Additional Method prototypes) ENABLED START -----*/
...
/*----- PROTECTED REGION END -----*/	//	VacuumValveSrv::Additional Method prototypes
};

/*----- PROTECTED REGION ID(VacuumValveSrv::Additional Classes Definitions) ENABLED START -----*/

class ValveCallback : public Tango::CallBack {
public:
	// Constructor
	ValveCallback(VacuumValveSrv* parent);
	// Destructor
	~ValveCallback();
	...
	// Get pressure
	double getPressure() { return ::pow(10.0, 2.0 * _analog_read.load() - 5.5); }
...
private:
	...
	// Command GPIO proxy
	Tango::AttributeProxy* _gpio_opn;
	// Command GPIO proxy
	Tango::AttributeProxy* _gpio_cls;
	...
	std::atomic<Tango::DevBoolean> _val_opn;
	std::atomic<Tango::DevBoolean> _val_cls;
...
/*----- PROTECTED REGION END -----*/	//	VacuumValveSrv::Additional Classes Definitions
