/*----- PROTECTED REGION ID(Polyscience::main.cpp) ENABLED START -----*/
...
// file :        main.cpp
//
// description : C++ source for the Polyscience device server main.
...
/*----- PROTECTED REGION END -----*/	//	Polyscience::main.cpp
