/*----- PROTECTED REGION ID(VibrationMeter::main.cpp) ENABLED START -----*/
...
// file :        main.cpp
//
// description : C++ source for the VibrationMeter device server main.
...
/*----- PROTECTED REGION END -----*/	//	VibrationMeter::main.cpp
