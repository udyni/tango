/*----- PROTECTED REGION ID(GpioSwitch::main.cpp) ENABLED START -----*/
...
// file :        main.cpp
//
// description : C++ source for the GpioSwitch device server main.
...
/*----- PROTECTED REGION END -----*/	//	GpioSwitch::main.cpp
